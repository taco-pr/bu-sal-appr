...
param.channels = 'DI';           % can include following characters: C or D (color), O (orientation), I (intensity), R (intensity on range data), S (orientation on range data), T (jump edges), U (roof edges), V (surface normals)
